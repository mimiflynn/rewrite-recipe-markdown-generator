    ...
    fun createModerneRecipes(
        ...
        Files.newBufferedWriter(moderneRecipesPath, StandardOpenOption.CREATE).useAndApply {
            writeln(
                """
        ---
        description: An autogenerated list of recipes that are exclusive to ${branding.platformName}.
        ---
        """.trimIndent()
            )
            writeln("\n# ${branding.platformName} Recipes\n")

            writeln(
                "This doc includes every recipe that is exclusive to users of ${branding.platformName}. " +
                        "For a full list of all recipes, check out our [recipe catalog](${branding.docsBaseUrl}/recipes). " +
                        "For more information about how to use ${branding.platformName} for automating code refactoring and analysis at scale, " +
                        "[contact us](${branding.contactUrl}).\n"
            )
